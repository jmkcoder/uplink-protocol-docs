        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">Uplink</span>
            </div>
            ...
            <div className="text-sm text-muted-foreground">
              Made with ✨ by <a className="underline hover:text-foreground transition-colors" href="https://github.com/jmkcoder" target="_blank" rel="noopener">@jmkcoder</a>
            </div>
          </div>
        </div>
      </footer>
