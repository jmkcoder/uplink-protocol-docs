...
}: DocsPageLayoutProps) {  return (
    <div className="flex justify-center min-h-screen bg-background text-foreground">      <div className="flex flex-1 max-w-[1600px] mx-auto">
        ...
        <main className="flex flex-1 flex-col">
          <div className="flex flex-1 flex-col xl:flex-row">
            {/* Main Content Area */}            <div 
              id="main-content" 
              className={`flex-1 px-4 sm:px-6 py-8 sm:py-12 ${showTableOfContents ? 'xl:min-w-0' : ''}`}
            >
              {children}
            ...
            </div>              {/* Right Sidebar - Document TOC */}
            {showTableOfContents && (
              /* Desktop TOC */
