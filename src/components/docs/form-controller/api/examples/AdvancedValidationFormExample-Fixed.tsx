  ...
  <label htmlFor="subscribe">Subscribe to newsletter</label>
      ...
      <div className="p-5 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 rounded-md">
        ...
        <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
          <li>Custom validators with full form context</li>
          <li>Conditional field requirements</li>
          <li>Cross-field validation (password matching)</li>
          <li>Dynamic UI updates based on validation state</li>
          <li>Proper error handling and display</li>
        </ul>
        
        <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-800 rounded-md text-sm">
          <span className="font-semibold">Implementation Note:</span> The key to implementing complex validation logic is registering custom validators that can access the full form context, including values of other fields.
        </div>
      </div>
      ...
      <div className="mt-6">
        <Tabs defaultValue="react" className="gap-0">
          ...
          <div className="flex items-center justify-between bg-primary/10 rounded-t-lg px-4 py-2 mt-2">
            ...
            <div className="text-xs text-muted-foreground">Advanced Validation Form Example</div>
          </div>
...
// Clean up validators when component is unmounted
onUnmounted(() => {
  methods.unregisterValidator('requiredIf');
  methods.unregisterValidator('equals');
});
...
<template>
  <form @submit="handleSubmit" class="space-y-6">
    ...
    <div class="form-field">
      <label>
        Phone Number <span class="required" v-if="state.formData.contact?.subscribe">*</span>
      </label>
      <input
        type="tel"
      ...
      />
      <div class="error" v-if="state.fieldErrors.contact?.phoneNumber">
        {{ state.fieldErrors.contact.phoneNumber }}
      </div>
    </div>
    ...
    <div class="form-field">
      ...
      />
      <div class="error" v-if="state.fieldErrors.contact?.password">
        {{ state.fieldErrors.contact.password }}
      </div>
    </div>
    ...
    <div class="form-field">
      ...
      />
      <div class="error" v-if="state.fieldErrors.contact?.confirmPassword">
        {{ state.fieldErrors.contact.confirmPassword }}
      </div>
    </div>
...
subscribeCheckbox.addEventListener('change', (e) => {
  ...
  // Update phone number required label UI
